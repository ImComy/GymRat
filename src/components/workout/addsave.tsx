...
const SavedWorkout = () => {
  ...
  const savedWorkoutsArray: Workout[] = [
    { name: 'Leg Day', type: 'Strength', date: '2023-10-02' },
    { name: 'Chest Pump', type: 'Strength', date: '2023-10-01' },
  ];
      ...
      {showPopup && (
        ...
        >
          <div className="relative w-[536px] h-auto bg-white rounded-lg shadow-2xl popup px-6 py-5 transition-all duration-300 ease-out mt-[50px]">
            ...
            {savedWorkoutsArray && savedWorkoutsArray.length > 0 ? (
              savedWorkoutsArray
                .filter((workout) =>
